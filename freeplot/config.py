...
cfg.reset = False
cfg.default_style = ["science", "high-vis", "no-latex"]  # color style: bright, vibrant, muted, high-contrast, light, high-vis, retro
cfg.lineplot_style = ["seaborn-darkgrid", {"axes.facecolor":".9"}]
cfg.scatterplot_style = ["seaborn-white"]
cfg.heatmap_style = ["seaborn-darkgrid", {"axes.facecolor":".9"}]
cfg.imageplot_style = ["seaborn-white"]
cfg.barplot_style = ["seaborn-whitegrid"]
